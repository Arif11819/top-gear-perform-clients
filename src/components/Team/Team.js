    ...
    <div className=" lg:p-10">
      ...
      <div className="grid lg:grid-cols-3 lg:gap:5 lg:gap-10 lg:mx-40">
        ...
        >
          <figure className="lg:px-10  lg:pt-10">
            <div className="avatar">
              <div className="lg:w-24 w-28 rounded-full">
                <img
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title font-bold text-2xl text-fuchsia-900 ">Ariful Islam</h2>
        ...
        >
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title font-bold text-fuchsia-900 text-2xl ">Mehady Hasan</h2>
        ...
        >
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title font-bold text-fuchsia-900 text-2xl ">Torikul Islam</h2>
            <p className="font-bold py-5 ">Member of Team The Errors</p>
          </div>
          <div className="grid gap-8 grid-cols-4 mb-10 mx-20 text-center ">
        ...
        >
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title font-bold text-fuchsia-900 text-2xl ">Sumaya  Islam</h2>
            <p className="font-bold py-5 ">Member of Team The Errors</p>
          </div>
          <div className="grid gap-8 grid-cols-4 mb-10 mx-20 text-center ">
        ...
        >
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title font-bold text-fuchsia-900 text-2xl ">Badhon Chaki</h2>
            <p className="font-bold py-5 ">Member of Team The Errors</p>
          </div>
          <div className="grid gap-8 grid-cols-4 mb-10 mx-20 text-center ">
        ...
        >
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title font-bold text-fuchsia-900 text-2xl ">Mazharul Islam</h2>
            <p className="font-bold py-5 ">Member of Team The Errors</p>
          </div>
