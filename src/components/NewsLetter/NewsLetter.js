    ...
    return (
        <div className="hero w-auto bg-slate-100">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div>
                    <h1 className="text-2xl font-bold">Keep Yourself Updated With All  </h1>
                    <h1 className="text-2xl font-bold"> The Latest News About</h1>
                    <h1 className="text-2xl font-bold"> TopgearPerform</h1>
