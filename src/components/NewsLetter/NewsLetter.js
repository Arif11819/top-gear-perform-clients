...
const NewsLetter = () => {
    ...
    return (
        <div className="hero w-auto bg-slate-50">
                    ...
                    <div className="form-control w-80">
                        ...
                        <div className="relative">
                            <form onSubmit={submitHandler}>
                                <input type="email" placeholder="Enter your valid email" className=" border-black w-full pr-16" required onChange={inputHandler} />
