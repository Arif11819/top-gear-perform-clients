    ...
    return (
        <div className='dark:bg-slate-50'>
            <div>
                ...
                <div className='p-3'>
                    <select onChange={handleTimeZone} id="timezone" className="bg-white border border-gray-300 dark:text-black text-nlack text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5   ">
            ...
            <div>
                ...
                <div className='p-3'>
                    <select onChange={handleLanguageSelect} id="language" className=" border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:text-black ">
