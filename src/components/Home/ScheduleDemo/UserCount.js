...
const UserCount = ({ userCount, setUserCount }) => {
        ...
        <div>
            <form className='flex justify-evenly py-2 gap-3'>
                <div>
                    ...
                    />
                    <label className='lvl' htmlFor="1st">
                        <div>
                            <h3>1-50 Users</h3>
                        </div>
                    </label>
                ...
                <div>
                    <input
                        ...
                        onChange={handleChange}
                    />
                    <label className='lvl' htmlFor="2nd">
                        <div>
                            <h3>51-100 Users</h3>
                        </div>
                    </label>
                ...
                <div>
                    <input
                        ...
                        onChange={handleChange}
                    />
                    <label className='lvl' htmlFor="3rd">
                        <h3>101-300 Users</h3>
                    </label>
                </div>
                <div>
                    <input
                        ...
                        onChange={handleChange}
                    />
                    <label className='lvl' htmlFor="4th">
                        <h3>301-500 Users</h3>
                    </label>
                </div>
                <div>
                    <input
                        ...
                        onChange={handleChange}
                    />
                    <label className='lvl' htmlFor="5th">
                        <h3>1000+ Users</h3>
                    </label>
                </div>
